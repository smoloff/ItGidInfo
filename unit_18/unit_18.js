...
function t4() {
    ...
    let temp = document.querySelectorAll('.task-4');
    let a4_res = new Array()

    temp.forEach(el => {
        a4_res.push(el.attributes.data.value)
    })
...
function t5() {
    ...
    let value = this.attributes.data.value
