...
function f6() {
    let k = document.querySelector('.i-61').value;
    let v = document.querySelector('.i-62').value;
    a6[k] = v;
...
function toOut(name, v) {
    document.querySelector(name).innerHTML = v;
}
...
function f7() {
    let k = document.querySelector('.i-7').value;
    let out = 0;
    for (let key in a7) {
        if (k == key) {
            out = 1;
...
function f8() {
    let k = document.querySelector('.i-8').value;
    let out = 0;
    for (let key in a8) {
        if (k == key) {
            out = a8[key];
...
function f11() {
    let k = document.querySelector('.i-11').value;
    let out = ''
    for (let key in a11) {
        if (key == k) {
            delete a11[key];
...
function f12() {
    let v = document.querySelector('.i-12').value;
    let out = ''
...
function f19() {
    ...
    let search = (element) => {
        return element.toLowerCase() == station.toLowerCase();
    }

    for (let key in a19) {
        if (a19[key].some(search)) {
            out = key;
        }
    }
